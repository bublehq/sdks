...
final class ChatCompletionsService
{
    ...
    {
        $body['stream'] = false;
        return $this->transport->request('POST', '/api/v1/chat/completions', $body);
    }
    ...
    {
        $body['stream'] = true;
        yield from $this->transport->stream('/api/v1/chat/completions', $body);
    }
    ...
    {
        yield from StreamText::fromEvents($this->stream($body), 'openai');
    }
}
